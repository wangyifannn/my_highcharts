var canvas = document.getElementById('canvas'),
    ...
    CENTROID_STROKE_STYLE = 'red',
    CENTROID_FILL_STYLE = 'green',

    RING_INNER_RADIUS = 55,
    RING_OUTER_RADIUS = 55,

    // ANNOTATIONS_FILL_STYLE = 'rgba(0, 0, 230, 0.9)',
    ANNOTATIONS_FILL_STYLE = 'red',
...
function drawGrid(color, stepx, stepy) {
    ...
    // for (var i = stepx + 0.5; i < 200; i += stepx) {
    //     context.beginPath();
    //     context.moveTo(i, 0);
...
function drawCentroidGuidewire(loc) {
    ...
    context.arc(endpt.x, endpt.y, 5, 0, Math.PI * 1.5, false);
    context.fill();
    context.stroke();
